...
NUM_CYCLES = 6
ix_offsets = [np.array(ix) for ix in set(permutations(3*(-1, 0, 1), 3)) if ix != (0, 0, 0)]
...
fullgrid[NUM_CYCLES,NUM_CYCLES:NUM_CYCLES+base_shape[0],NUM_CYCLES:NUM_CYCLES+base_shape[1]] = np.vectorize(value_map.get)(grid)
